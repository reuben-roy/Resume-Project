...
export function fetchHabiticaStats(){
    ...
    .then((userData) => {
      document.getElementById("lvl").innerHTML = `<h6 style="flex-basis: 100%">Level: ${userData.data.stats.lvl}</h6><h6 style="flex-basis: 100%">Class: ${userData.data.stats.class.toUpperCase()}</h6>`
